...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthResponse> getValidation(@RequestHeader("Authorization") String token) {
        AuthResponse authResponse = new AuthResponse(null, false);
        log.info("Token validation for ", userService.getUsernameFromToken(token));
